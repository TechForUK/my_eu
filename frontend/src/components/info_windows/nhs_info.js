...
const NhsInfo = ({ name, organisation }) => {
  ...
  return (
    <div className="my-eu-info-window">
      ...
      <p>
        {name} is part of the {data.organisation_name}.
      </p>
      ...
      <p>
        An NHS hospital ward typically contains 24 beds, and needs 29 nurses to
        keep it running smoothly. Many NHS nurses and NHS doctors are from the
        EU.
      </p>
      <Share message={tweet} />
    </div>
